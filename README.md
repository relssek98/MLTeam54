...
| Olivia Mauger | For the midterm: Completed 3 pre-processing methods (Remove Emojis, URLs, and to Lowercase) Edited and helped with discussion on pre-processing errors , For the proposal: Helped with creating GitHub page and styled it using Markdown, recorded video and uploaded to YouTube, wrote Potential Results & Discussion section with Liz    |
